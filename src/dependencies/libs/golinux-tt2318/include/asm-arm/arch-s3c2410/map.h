...
#define S3C24XX_VA_GPIO	   ((S3C2410_PA_GPIO - S3C2410_PA_UART) + S3C24XX_VA_UART)
...
#define S3C2413_PA_CAMIF   (0x4D800000)
#define S3C24XX_SZ_CAMIF   SZ_1M

/* HS-MMC */
#define S3C2443_VA_HSMMC   S3C2410_ADDR(0x01400000)
#define S3C2443_PA_HSMMC   (0x4A800000)
#define S3C2443_SZ_HSMMC   SZ_1M

/* HS-UDC */
#define S3C_VA_HSUDC	   S3C2410_ADDR(0x01500000)
#define S3C_PA_HSUDC       (0x49800000)
#define S3C_SZ_HSUDC       SZ_1M
