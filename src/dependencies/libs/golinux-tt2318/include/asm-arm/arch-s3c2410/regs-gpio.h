...
#define S3C2410_GPBSLPCON  S3C2410_GPIOREG(0x1c)	// S3C2412/S3C2413
...
#define S3C2410_GPCSLPCON  S3C2410_GPIOREG(0x2c)	// S3C2412/S3C2413
...
#define S3C2410_GPDSLPCON  S3C2410_GPIOREG(0x3c)	// S3C2412/S3C2413
...
#define S3C2410_GPESLPCON  S3C2410_GPIOREG(0x4c)	// S3C2412/S3C2413
...
#define S3C2410_GPHSLPCON  S3C2410_GPIOREG(0x7c)	// S3C2412/S3C2413
...
#define S3C2443_GPH12_UCLK    (0x02 << 24)
...
#define S3C2443_GPJCON		S3C2410_GPIOREG(0xd0)
#define S3C2443_GPJDAT		S3C2410_GPIOREG(0xd4)
#define S3C2443_GPJUDP		S3C2410_GPIOREG(0xd8)
...
#define S3C2443_DATAPDEN	S3C2410_GPIOREG(0xe8)
...
#define S3C2410_MSLCON	   S3C2410_GPIOREG(0xcc)

#ifdef CONFIG_CPU_S3C2412
#define S3C2412_MISCCR	   S3C2410_GPIOREG(0x90)
#define S3C2412_DCLKCON	   S3C2410_GPIOREG(0x94)
#define S3C2412_MSLCON	   S3C2410_GPIOREG(0xd8)
#endif /* CONFIG_CPU_S3C2412 */

#define S3C2410_MSLCON_PSC_DATA     (1<<11)
...
#define S3C2410_MISCCR_nRSTCON	    (1<<16)	// NOT on S3C2412/S3C2413

#define S3C2410_MISCCR_nEN_SCLK0    (1<<17)
#define S3C2410_MISCCR_nEN_SCLK1    (1<<18)
#define S3C2410_MISCCR_nEN_SCLKE    (1<<19)	// NOT on S3C2412/S3C2413
#define S3C2410_MISCCR_SDSLEEP	    (7<<17)

#ifdef CONFIG_CPU_S3C2412

/* miscellaneous control for S3C2412/S3C2413 */
...
#define S3C2412_MISCCR_USBDEV	    (0)	
#define S3C2412_MISCCR_USBHOST	    (1<<3)

#define S3C2412_MISCCR_CLK0_MPLL    (0<<4)
#define S3C2412_MISCCR_CLK0_UPLL    (1<<4)
#define S3C2412_MISCCR_CLK0_FCLK    (2<<4)
#define S3C2412_MISCCR_CLK0_HCLK    (3<<4)
#define S3C2412_MISCCR_CLK0_PCLK    (4<<4)
#define S3C2412_MISCCR_CLK0_DCLK0   (5<<4)

#define S3C2412_MISCCR_CLK1_MPLL    (0<<8)
#define S3C2412_MISCCR_CLK1_UPLL    (1<<8)
#define S3C2412_MISCCR_CLK1_FCLK    (2<<8)
#define S3C2412_MISCCR_CLK1_HCLK    (3<<8)
#define S3C2412_MISCCR_CLK1_PCLK    (4<<8)
#define S3C2412_MISCCR_CLK1_DCLK1   (5<<8)

#define S3C2412_MISCCR_USBSUSPND0   (1<<12)
#define S3C2412_MISCCR_USBSUSPND1   (1<<13)

#define S3C2412_MISCCR_nEN_SCLK     (1<<17)
#define S3C2412_MISCCR_nEN_nSCLK    (1<<18)

#endif /* CONFIG_CPU_S3C2412 */

#ifdef CONFIG_CPU_S3C2443

/* miscellaneous control for S3C2443 */
#define S3C2443_MISCCR_CLK0_MPLL    (0<<4)
#define S3C2443_MISCCR_CLK0_EPLL    (1<<4)
#define S3C2443_MISCCR_CLK0_FCLK    (2<<4)
#define S3C2443_MISCCR_CLK0_HCLK    (3<<4)
#define S3C2443_MISCCR_CLK0_PCLK    (4<<4)
#define S3C2443_MISCCR_CLK0_DCLK0   (5<<4)
#define S3C2443_MISCCR_CLK0_OSC     (6<<4)

#define S3C2443_MISCCR_CLK1_EPLL    (1<<8)
#define S3C2443_MISCCR_CLK1_RTC     (2<<8)
#define S3C2443_MISCCR_CLK1_HCLK    (3<<8)
#define S3C2443_MISCCR_CLK1_PCLK    (4<<8)
#define S3C2443_MISCCR_CLK1_DCLK1   (5<<8)

#define S3C2443_MISCCR_USBSUSPND    (1<<12)

// #define S3C2443_MISCCR_nRSTCON      (1<<16)	// NOT in the manual

#define S3C2443_MISCCR_FLT_IIC      (1<<24)

#define S3C2443_MISCCR_LCD_SEL      (1<<28)

#define S3C2443_MISCCR_nCD_CF       (1<<30)
#define S3C2443_MISCCR_HSSPI_EN     (1<<31)
