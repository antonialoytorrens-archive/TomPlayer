...
/* Samsung S3C2412 SoC */
#define PORT_S3C2412	69

/* Samsung S3C2443 SoC */
#define PORT_S3C2443	70
...
extern void gpio_handle_break(int uart);
#endif
...
#ifdef CONFIG_SERIAL_S3C2410_TIMESTAMP 
/*
 * enable_timestamps is used to enable a timestamping of NMEA mesages
 * specific to the TomTom GO device.
 */
	int			enable_timestamps;
#endif /* CONFIG_SERIAL_S3C2410_TIMESTAMP */
