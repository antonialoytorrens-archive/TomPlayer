...
{
  mpctx->eof = 0;
  uninit_player(INITED_ALL-(INITED_SAVED_VOL|INITED_GUI|INITED_STREAM|INITED_INPUT|INITED_GETCH2|(fixed_vo?INITED_VO:0)));
...
uninit_player(INITED_ALL-(INITED_SAVED_VOL+INITED_GUI+INITED_INPUT+(fixed_vo?INITED_VO:0)));
